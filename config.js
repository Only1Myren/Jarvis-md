...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_2a73_9aab_2be3_a2b0_a77d_7431_bc8d_67a8',
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'Truth シ;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      only the gods can use my sticker 🗿',
